 ...
 */
export const generatePseudocode = (jsCode: string | undefined): string => {
  if (!jsCode) return '';
...
const TrafficDot: React.FC<TrafficDotProps> = ({ color, hoverTitle }) => {
...
const CodeBlock: React.FC<CodeBlockProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 bg-gray-50 dark:bg-neutral-950 border-b border-gray-200 dark:border-gray-700 w-full">
