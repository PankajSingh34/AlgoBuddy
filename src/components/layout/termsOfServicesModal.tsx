...
const TermsOfServiceModal: React.FC<TermsOfServiceModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 max-w-3xl w-full rounded-xl shadow-2xl overflow-hidden transform transition-all duration-300 max-h-[90vh] flex flex-col border border-neutral-200 dark:border-neutral-700">
                ...
                <li key={index} className="mb-4">
                  <div className="bg-neutral-50 dark:bg-neutral-800/40 p-5 rounded-xl border border-neutral-200 dark:border-neutral-700 transition-all duration-300">
                    <div className="flex items-start">
                      ...
                      <h3 className="text-xl font-bold font-serif text-neutral-900 dark:text-neutral-100 mb-2">
                        {item.title}
                      </h3>
                    </div>
                    {item.points && (
                      <ul className="space-y-2 text-neutral-600 dark:text-neutral-400 pl-9 mb-2">
        ...
        <div className="sticky bottom-0 bg-white dark:bg-neutral-900 border-t border-neutral-200 dark:border-neutral-700 p-4 flex justify-end">
          <button
            onClick={onClose}
