...
,
  "edit-distance": {
    ...
    title: "Edit Distance",
    category: "Dynamic Programming",
    description: "Given two strings, find the minimum number of operations (insert, delete, replace) required to convert one string into the other.",
    summary: [
      "Edit Distance builds a 2D matrix where dp[i][j] represents the minimum operations needed to convert the first i characters of str1 into the first j characters of str2.",
      "If characters match, no operation is needed at that step. Otherwise, we take 1 plus the minimum of insert, delete, or replace operations."
    ],
    steps: [
      "Initialize a DP table of size (n+1) x (m+1).",
      "Fill the first row and column with 0 to n and 0 to m (base case: converting to/from empty string).",
      "Iterate through each character of str1 (i from 1 to n) and str2 (j from 1 to m).",
      "If str1[i-1] == str2[j-1], dp[i][j] = dp[i-1][j-1] (no operation needed).",
