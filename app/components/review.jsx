              ...
              >
                ...
                <div className="flex justify-end">
                  <motion.button
                    ...
                    className="px-6 py-3 bg-udemy-purple hover:bg-udemy-purple-dark text-white font-bold rounded transition-all shadow-md hover:shadow-lg flex items-center"
                  >
                    {isSubmitting ? (
                      <>
                        <svg
