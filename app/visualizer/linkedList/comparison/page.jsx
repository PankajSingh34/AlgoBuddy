import Animation from "@/app/visualizer/linkedlist/comparison/animation";
import Content from "@/app/visualizer/linkedlist/comparison/content";
import Quiz from "@/app/visualizer/linkedlist/comparison/quiz";
import CodeBlock from "@/app/visualizer/linkedlist/comparison/codeBlock";
      ...
      exploreOther={
        <ExploreOther
          ...
          links={[
            ...
            { text: "Merging", url: "./mergedlists" },
            { text: "Searching", url: "./search" },
            { text: "Reverse", url: "./reverselinkedlist" },
          ]}
        />
      }
    />
