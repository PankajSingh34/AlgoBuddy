...
=======
              className="rounded-lg bg-purple-600 px-6 py-3 text-white disabled:bg-gray-400"
...
=======
                    <div className="data-part w-16 rounded-l-lg bg-purple-500 p-3 text-center text-base text-white sm:w-20 sm:p-4 sm:text-lg">
                      {node.value}
                    </div>
                    <div className="next-part w-16 rounded-r-lg bg-purple-300 p-3 text-center font-mono text-xs dark:bg-purple-600 sm:w-20 sm:p-4 sm:text-base">
>>>>>>> c8abb0c (Refactor color scheme from blue to purple across visualizer components for a cohesive design update)
                      {node.next}
                    </div>
                  </div>
