            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 flex flex-col gap-2">
              <div className="flex justify-between items-center text-xs">
                <span className="text-slate-600 font-semibold flex items-center gap-1.5">
                  <Info className="w-3.5 h-3.5 text-indigo-600" /> Current Step Activity
                </span>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-3xl p-6 shadow-inner relative overflow-hidden flex flex-col justify-center min-h-[440px] items-center">
              ...
              <div className="absolute top-4 left-4 flex flex-wrap gap-2 text-xs">
                <div className="flex items-center gap-1.5 bg-slate-50 border border-slate-200 px-2.5 py-1 rounded-lg">
                  ...
                  <span className="text-slate-600">Current Node (curr)</span>
                </div>
                <div className="flex items-center gap-1.5 bg-slate-50 border border-slate-200 px-2.5 py-1 rounded-lg">
                ...
                {mode === 'morris' && (
                  <>
                    <div className="flex items-center gap-1.5 bg-slate-50 border border-slate-200 px-2.5 py-1 rounded-lg">
                      ...
                      <span className="text-slate-600">Predecessor (pred)</span>
                    </div>
                    <div className="flex items-center gap-1.5 bg-slate-50 border border-slate-200 px-2.5 py-1 rounded-lg">
                      <span className="w-6 border-t-2 border-dashed border-purple-500"></span>
                      <span className="text-slate-600">Temporary Thread Link</span>
                    </div>
                  </>
                )}
              </div>
                ...
                <div className="overflow-auto w-full flex justify-center py-6">
                  ...
                  >
                    ...
                    {renderNodes.map((node, idx) => {
                      ...
                      let nodeColor = 'bg-slate-900 border-slate-700 text-slate-700';
                      let fillHex = '#f0f9ff';
              ...
              {currentStep && (
                <div className="w-full mt-4 border-t border-slate-200 pt-4 flex flex-col gap-2 bg-slate-50 p-4 rounded-xl border border-slate-200">
                  {mode === 'level-order' && (
                    <div className="flex items-center gap-3">
                      <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider w-16">FIFO Queue:</div>
                            ...
                            <div
                              ...
                              className={`px-3 py-1 text-xs font-bold rounded-lg border flex items-center justify-center min-w-8 ${
                                qidx === 0
                                  ...
                                  : 'bg-slate-900 border-slate-200 text-slate-600'
                              }`}
                            >
                              {val}
                            </div>
                  ...
                  {(mode === 'pre-order' || mode === 'in-order' || mode === 'post-order') && (
                    <div className="flex items-center gap-3">
                      <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider w-16">Call Stack:</div>
                      <div className="flex items-center gap-1.5 overflow-x-auto py-1">
                        {currentStep.stack && currentStep.stack.length > 0 ? (
                          currentStep.stack.map((val, sidx) => (
                            <div
                              key={`s-${sidx}`}
                              className="px-3 py-1 text-xs font-bold rounded-lg border bg-indigo-950/20 text-indigo-700 border-indigo-500/20"
                            >
                              {val}
                            </div>
                          ))
                  ...
                  <div className="flex items-center gap-3 mt-1.5 border-t border-slate-200 pt-2">
                    <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider w-16">Result Path:</div>
