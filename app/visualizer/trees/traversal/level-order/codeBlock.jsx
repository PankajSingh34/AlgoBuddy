...
const CodeBlock = () => {
  ...
  const codeExamples = {
    javascript: `// Level-Order Traversal in JavaScript
...
function levelOrderByLevel(root) {
  ...
  return result;
    ...
    python: `# Level-Order Traversal in Python
...
def level_order_by_level(root):
    ...
    java: `// Level-Order Traversal in Java
...
void levelOrder(struct Node* root) {
    ...
    cpp: `// Level-Order Traversal in C++
#include <iostream>
#include <queue>
#include <vector>
using namespace std;
      ...
      >
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 bg-gray-50 dark:bg-neutral-950 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center mb-2 sm:mb-0">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Level-Order Traversal Implementation</h3>
          </div>
          <motion.button
