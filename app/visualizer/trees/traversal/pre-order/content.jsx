...
const content = () => {
  ...
  const paragraphs = [
    "Pre-order traversal is a depth-first tree traversal technique where nodes are visited in the order: Root → Left → Right. Starting at the root, you visit the current node first, then recursively traverse the entire left subtree, and finally the right subtree. This means the node is processed before any of its children.",
    "Pre-order traversal is widely used for creating a copy of a tree (serialization), generating prefix expressions from expression trees, and printing tree structures in a hierarchical format. Its recursive nature makes it the simplest traversal to implement, while the iterative approach offers stack-based control.",
  ];
  ...
  const walkthroughSteps = [
    { points: "Start at root (1). Visit 1 first." },
    { points: "Go left to 2. Visit 2." },
    { points: "From 2, go left to 4. Visit 4. No children → backtrack." },
    { points: "From 2, go right to 5. Visit 5. No children → backtrack." },
    { points: "Back to root 1, left subtree done. Go right to 3. Visit 3." },
    { points: "From 3, go left to 6. Visit 6." },
    { points: "Final order: [1, 2, 4, 5, 3, 6]" },
  ];
  ...
  const applications = [
    { points: "Tree serialization — creates a copy of the tree structure" },
    { points: "Prefix expression evaluation from expression trees" },
    { points: "Printing tree in hierarchical format" },
    { points: "Top-down tree traversal algorithms" },
    { points: "Syntax tree traversal in compilers" },
  ];
    ...
    <main className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 md:gap-4">
      ...
      <article className="col-span-4 max-w-4xl bg-white dark:bg-[#111] rounded-2xl border border-[#e5e7eb] dark:border-[#222] overflow-hidden mb-8">
        ...
        <section className="p-6 border-b border-[#f3f4f6] dark:border-[#1e1e1e]">
          <h1 className="text-2xl font-bold text-[#1a1a1a] dark:text-white mb-4 flex items-center">
            <span className="w-1 h-6 bg-[#a435f0] mr-3 rounded-full"></span>
            Traversal Algorithm (Root &rarr; Left &rarr; Right)
          </h1>
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-[#374151] dark:text-[#d1d5db] mb-4 leading-relaxed">
              The pre-order traversal follows a simple recursive pattern:
            </p>
  ...
  while (stack.length) {
    ...
    if (curr.left) stack.push(curr.left);
        ...
        <section className="p-6 border-b border-[#f3f4f6] dark:border-[#1e1e1e]">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-[#374151] dark:text-[#d1d5db] mb-4 leading-relaxed">
              Both recursive and iterative pre-order traversal visit each node exactly once, giving O(n) time.
