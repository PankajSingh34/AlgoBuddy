...
const CodeBlock = () => {
  ...
  const codeExamples = {
    javascript: `// Post-Order Traversal in JavaScript
...
function postOrderIterative(root) {
  ...
  return result;
    ...
    python: `# Post-Order Traversal in Python
...
def post_order_iterative(root):
    ...
    java: `// Post-Order Traversal in Java
      ...
      >
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 bg-gray-50 dark:bg-neutral-950 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center mb-2 sm:mb-0">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Post-Order Traversal Implementation</h3>
          </div>
          <motion.button
